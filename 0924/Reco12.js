...
//모델파일 사용안함
// 피어슨 상관 계수+히스토그램
// 피어슨 상관 계수 : 두 벡터 간의 선형 상관 관계를 측정하는 통계적 지표입니다. 
...
// 이미지 간의 유사성 메트릭스 계산 함수 (피어슨 상관 계수)
         ...
         try {
           ...
           for (const imagePath of imagePaths) {
             try {
               ...
               // 이미지 간의 유사성 메트릭스 계산 (피어슨 상관 계수)
               const pearsonCorrelation = calculatePearsonCorrelation(inputHistogram, folderHistogram);
       
               console.log('Pearson Correlation for', imagePath, ':', pearsonCorrelation); // 유사성 메트릭스 출력
