...
// import * as tfjs from '@tensorflow/tfjs-image';
// //useRef, useCallback
...
// //수정된곳(0917)
// //모델파일 사용함 
// //두 텐서 간의 구조적 유사도(SSIM)
// //두 이미지의 픽셀 값의 유사도뿐만 아니라 이미지의 구조적 유사도
...
//              const ssim = tfjs.ssim(pretrainedImageTensor, folderImageTensor);
//              console.log('SSIM:', ssim);
//              similarImages.push({ imagePath, ssim });
//            }
       
//            // 유사도에 따라 유사한 이미지 정렬
//            similarImages.sort((a, b) => a.ssim - b.ssim);
...
//   try {
//       const topSimilarImages = await calculateSSIM ();
