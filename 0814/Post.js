...
function PostEx() {
    ...
    //해시태그 처리
    const updateDescriptionWithHashtags = (newDescription) => {
      setDescription(newDescription);
      const extractedHashtags = newDescription.match(/#\w+/g) || [];
                        ...
                        <Content>
                            ...
                            <Four>{/* 설명 */}
                                ...
                                <WrapPer>
                                  <TextareaBasic
                                    value={description}
                                    onChange={(e) => updateDescriptionWithHashtags(e.target.value)}
                                    placeholder="설명"
                                  />
                                </WrapPer>
